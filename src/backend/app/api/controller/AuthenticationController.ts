...
import { findAllWorkers, findWorker, createWorker, login, validateUser } from "../service/AuthenticationService"

var router = express.Router();

// middleware that is specific to this router
router.use(function timeLog(req, res, next) {
	console.log('[' + Date.now() + '|AuthenticationController] Request: ' + req.url);
	next()
});
